local UIShopIngot=class("UIShopIngot",function() return ccui.Layout:create() end)
local UIShopItem=require("src/ui_shopitem")
local g_path=BPRESOURCE("res/usercenter/")
require("bptools/class_tools")
function UIShopIngot:ctor()
   print("hjjlog>>UIShopIngot")
   self.list_item={}
   self.list_item_sleep={};
   self:init();

end
function UIShopIngot:destory()
end


function UIShopIngot:init()
...
function UIShopIngot:clear_item()
...
function UIShopIngot:get_a_gold_item()
