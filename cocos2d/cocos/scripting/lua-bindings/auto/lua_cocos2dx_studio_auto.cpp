...
int lua_cocos2dx_studio_SceneReader_createNodeWithSceneFile(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        cocos2d::Node* ret = cobj->createNodeWithSceneFile(arg0, cocostudio::SceneReader::AttachComponentType::EMPTY_NODE, id);
        object_to_luaval<cocos2d::Node>(tolua_S, "cc.Node",(cocos2d::Node*)ret);
        return 1;
    }
    if (argc == 2) 
    {
        ...
        cocos2d::Node* ret = cobj->createNodeWithSceneFile(arg0, arg1, id);
        object_to_luaval<cocos2d::Node>(tolua_S, "cc.Node",(cocos2d::Node*)ret);
        return 1;
    }
